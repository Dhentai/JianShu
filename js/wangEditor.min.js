! function(e, t) {
	...
	function l(e, t) {
		...
		A.append(d), a.forEach(function(e) {
			...
			t && (c.append(t), d.append(c), t.on("click", function(e) {
	...
	function d(e) {
		var t = this;
		this.editor = e, this.$elem = o('<div class="w-e-menu"><i class="w-e-icon-header"><i/></div>'), this.type = "droplist", this._active = !1, this.droplist = new l(this, {
			width: 100,
			$title: o("<p>设置标题</p>"),
			type: "list",
			list: [{
	...
	function v(e) {
		var t = this;
		this.editor = e, this.$elem = o('<div class="w-e-menu"><i class="w-e-icon-list2"><i/></div>'), this.type = "droplist", this._active = !1, this.droplist = new l(this, {
			width: 120,
			$title: o("<p>设置列表</p>"),
			type: "list",
			list: [{
	...
	function b(e) {
		var t = this;
		this.editor = e, this.$elem = o('<div class="w-e-menu"><i class="w-e-icon-paragraph-left"><i/></div>'), this.type = "droplist", this._active = !1, this.droplist = new l(this, {
			width: 100,
			$title: o("<p>对齐方式</p>"),
			type: "list",
			list: [{
	...
	function E(e) {
		var t = this;
		this.editor = e, this.$elem = o('<div class="w-e-menu"><i class="w-e-icon-pencil2"><i/></div>'), this.type = "droplist", this._active = !1, this.droplist = new l(this, {
			width: 120,
			$title: o("<p>文字颜色</p>"),
			type: "inline-block",
			list: [{
	...
	function y(e) {
		var t = this;
		this.editor = e, this.$elem = o('<div class="w-e-menu"><i class="w-e-icon-paint-brush"><i/></div>'), this.type = "droplist", this._active = !1, this.droplist = new l(this, {
			width: 120,
			$title: o("<p>背景色</p>"),
			type: "inline-block",
			list: [{
	...
	function D(e) {
		this.editor = e, this.$elem = o('<div class="w-e-menu"><i class="w-e-icon-image"><i/></div>'), this.type = "panel", this._active = !1
	}
	...
	function _(e, t) {
		...
		if (null == n ? i = window.clipboardData && window.clipboardData.getData("text") : (i = n.getData("text/plain"), o = n.getData("text/html")), !o && i && (o = "<p>" + a(i) + "</p>"), o) {
			var A = o.split("</html>");
			return 2 === A.length && (o = A[0]), o = o.replace(/<(meta|script|link).+?>/gim, ""), o = t ? o.replace(/\s?(class|style)=('|").+?('|")/gim, "") : o.replace(/\s?class=('|").+?('|")/gim, "")
		}
	}
	...
	function H(e, t) {
		...
		this.id = "wangEditor-" + G++, this.toolbarSelector = e, this.textSelector = t, this.customConfig = {}
	}
	i.prototype = {
		constructor: i,
		forEach: function(e) {
		...
		on: function(e, t, n) {
			...
			return i = e.split(/\s+/), this.forEach(function(e) {
				i.forEach(function(i) {
					if (i) return t ? void e.addEventListener(i, function(e) {
						var i = e.target;
	...
	u.prototype = {
		...
		show: function() {
			...
			if (!($.indexOf(t) >= 0)) {
				...
				g.length && g.get(0).focus(), this.$container = c, this._hideOtherPanels(), $.push(t)
			}
		},
		hide: function() {
			var e = this.menu,
				t = this.$container;
			t && t.remove(), $ = $.filter(function(t) {
				return t !== e
			})
		},
		...
		onClick: function(e) {
			var t = this.editor;
			if (!L.isIE()) return void t.cmd.do("formatBlock", "<BLOCKQUOTE>");
			var n = t.selection.getSelectionContainerElem(),
				i = void 0,
				A = void 0;
			if ("P" === n.getNodeName()) return i = n.text(), A = o("<blockquote>" + i + "</blockquote>"), A.insertAfter(n), void n.remove();
			"BLOCKQUOTE" === n.getNodeName() && (i = n.text(), A = o("<p>" + i + "</p>"), A.insertAfter(n), n.remove())
		},
		tryChangeActive: function(e) {
			var t = this.editor,
				n = this.$elem,
			...
			var i = new u(this, {
				...
				tabs: [{
					...
					events: [{
						...
						fn: function(t) {
							var n = t.target;
							return e._insert(n.innerHTML), !0
						}
					}]
				}, {
					title: "手势",
	...
	var J = {};
	J.bold = s, J.head = d, J.link = h, J.italic = p, J.redo = f, J.strikeThrough = g, J.underline = m, J.undo = w, J.list = v, J.justify = b, J.foreColor = E, J.backColor = y, J.quote = B, J.code = C, J.emoticon = x, J.table = I, J.video = Q, J.image = D, k.prototype = {
		constructor: k,
		init: function() {
			var e = this,
				t = this.editor;
		...
		_bindEvent: function() {
			this._saveRangeRealTime(), this._enterKeyHandle(), this._clearHandle(), this._pasteHandle(), this._tabHandle(), this._imgHandle()
		},
		...
		_enterKeyHandle: function() {
			function e(e) {
				...
				if (t.parent().equal(i) && ("P" !== t.getNodeName() && !t.text())) {
					var A = o("<p><br></p>");
					A.insertBefore(t), n.selection.createRangeByElem(A, !0), n.selection.restoreSelection(), t.remove()
				}
			}
			...
			function t(e) {
				...
				if (t) {
					var i = t.parent(),
						A = t.getNodeName(),
						r = i.getNodeName();
					if ("CODE" === A && "PRE" === r && n.cmd.queryCommandSupported("insertHTML")) {
						if (!0 === n._willBreakCode) {
							var c = o("<p><br></p>");
							return c.insertAfter(i), n.selection.createRangeByElem(c, !0), n.selection.restoreSelection(), n._willBreakCode = !1, void e.preventDefault()
						}
						var a = n.selection.getRange().startOffset;
						n.cmd.do("insertHTML", "\n"), n.selection.saveRange(), n.selection.getRange().startOffset === a && n.cmd.do("insertHTML", "\n");
						var s = t.html().length;
						n.selection.getRange().startOffset + 1 === s && (n._willBreakCode = !0), e.preventDefault()
					}
				}
			}
			var n = this.editor,
		...
		_pasteHandle: function() {
			var e = this.editor,
				t = e.config.pasteFilterStyle,
				n = e.$textElem;
			n.on("paste", function(i) {
				if (!L.isIE()) {
					i.preventDefault();
					var o = _(i, t),
						A = M(i);
					A = A.replace(/\n/gm, "<br>");
					var r = e.selection.getSelectionContainerElem();
					if (r) {
						var c = r.getNodeName();
						if ("CODE" !== c && "PRE" !== c)
							if ("DIV" !== c && "<p><br></p>" !== n.html() && t) {
								if (!A) return;
								e.cmd.do("insertHTML", "<p>" + A + "</p>")
							} else {
								if (!o) return;
								try {
									e.cmd.do("insertHTML", o)
								} catch (t) {
									e.cmd.do("insertHTML", "<p>" + A + "</p>")
								}
							}
		...
		_imgHandle: function() {
			var e = this.editor,
				t = e.$textElem;
			t.on("click", "img", function(n) {
				var i = this,
					A = o(i);
				t.find("img").removeClass("w-e-selected"), A.addClass("w-e-selected"), e._selectedImg = A, e.selection.createRangeByElem(A)
			}), t.on("click  keyup", function(n) {
	...
	T.prototype = {
		...
		insertLinkImg: function(e) {
			var t = this;
			if (e) {
				this.editor.cmd.do("insertHTML", '<img src="' + e + '" class="imgEtc" style="max-width:88%; max-width: 88%; margin:10px auto; resizeable=no;"/>');
				var n = document.createElement("img");
				n.onload = function() {
					n = null;
					/*var new_element=document.createElement("script");
					    new_element.setAttribute("type","text/javascript");
					    new_element.setAttribute("src","js/wangEditorExtra.js");
					    document.body.appendChild(new_element);*/
				}, n.onerror = function() {
					n = null, t._alert("插入图片错误", 'wangEditor: 插入图片出错，图片链接是 "' + e + '"，下载该链接失败')
				}, n.onabort = function() {
					n = null
				}, n.src = e
			}
		...
		uploadImg: function(e) {
			...
			if (e && e.length) {
				...
				if (r(w, function(e) {
					...
					var y = E[1] || "";
					A(u, function(e, t) {
						t = encodeURIComponent(t), s.indexOf("?") > 0 ? s += "&" : s += "?", s = s + e + "=" + t, b.append(e, t)
					}), y && (s += "#" + y);
					var B = new XMLHttpRequest;
					if (B.open("POST", s), B.timeout = f, B.ontimeout = function() {
							p.timeout && "function" == typeof p.timeout && p.timeout(B, n), t._alert("上传图片超时")
							...
							var e = void 0;
							if (4 === B.readyState) {
								if (B.status < 200 || B.status >= 300) return p.error && "function" == typeof p.error && p.error(B, n), void t._alert("上传图片发生错误", "上传图片发生错误，服务器返回状态是 " + B.status);
								if (e = B.responseText, "object" !== (void 0 === e ? "undefined" : O(e))) try {
									e = JSON.parse(e)
								} catch (i) {
									return p.fail && "function" == typeof p.fail && p.fail(B, n, e), void t._alert("上传图片失败", "上传图片返回结果错误，返回结果是: " + e)
								}
								...
								} else p.fail && "function" == typeof p.fail && p.fail(B, n, e), t._alert("上传图片失败", "上传图片返回结果错误，返回结果 errno=" + e.errno)
							}
						}, p.before && "function" == typeof p.before) {
						var C = p.before(B, n, w);
						if (C && "object" === (void 0 === C ? "undefined" : O(C)) && C.prevent) return void this._alert(C.msg)
					}
					return A(h, function(e, t) {
						B.setRequestHeader(e, t)
					}), B.withCredentials = g, void B.send(b)
				}
				l && r(e, function(e) {
					var n = t,
						i = new FileReader;
	...
	H.prototype = {
		...
		_initDom: function() {
			var e = this,
				...
				s = void 0,
				l = void 0;
			null == i ? (c = o("<div></div>"), a = o("<div></div>"), l = n.children(), n.append(c).append(a)) : (c = n, a = o(i), l = a.children()), s = o("<div></div>"), s.attr("contenteditable", "true").css("width", "100%").css("height", "100%"), l && l.length ? s.append(l) : s.append(o("<p><br></p>")), a.append(s), c.addClass("w-e-toolbar"), a.addClass("w-e-text-container"), s.addClass("w-e-text"), this.$toolbarElem = c, this.$textContainerElem = a, this.$textElem = s, a.on("click keyup", function() {
				e.change && e.change()
			}), c.on("click", function() {
		...
		_initMenus: function() {
			this.menus = new k(this), this.menus.init()
		},
		_initText: function() {
			this.txt = new S(this), this.txt.init()
		},
